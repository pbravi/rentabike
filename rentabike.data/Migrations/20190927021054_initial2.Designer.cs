...
namespace rentabike.data.Migrations
{
    ...
    [Migration("20190927021054_initial2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("rentabike.model.strategies.PriceStrategy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("rentabike.model.strategies.PriceStrategyRentalType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasData(
                        ...
                        new { Id = 4, Discount = 30.0, Price = 0.0, PriceStrategyId = 1, RentalTypeId = 4 }
                    );
                });
            ...
            modelBuilder.Entity("rentabike.model.strategies.PriceStrategyRentalType", b =>
                {
                    b.HasOne("rentabike.model.strategies.PriceStrategy", "PriceStrategy")
                        .WithMany("PriceStrategyRentalTypes")
